...
describe('SignUp Controller', () => {
  test('should return status code 400 if name not provided', async () => {
    // system under test
    const { sut } = makeSUT()
  ...
  test('should return status code 400 if no password confirmation is provided', async () => {
    // system under test
    const { sut } = makeSUT()
    // Body request method Post without name
    const httpRequest = {
  ...
  test('should return status code 400 if is invalid e-mail', async () => {
    // system under test
  ...
  test('should return status code 200 if valid data is provided', async () => {
    const { sut } = makeSUT()
